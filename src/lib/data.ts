export const siteConfig = {
  name: "K. Fox Photography",
  tagline: "SF Bay Area Brand Photography + Videography",
  description:
  ...
  instagram: "https://www.instagram.com/k.foxphotography/",
  honeybook: "https://www.honeybook.com/p.png?pid=62d860577fcc960009eb306e",
};
...
export const faqs = [
  {
    question: "What is Brand Photography?",
    answer:
      "Brand photography is the art of creating a unique, visual narrative for your business through personalized and professional images that showcase your brand's personality, values, and offerings. Unlike generic stock photos, customized brand photography is carefully tailored to represent the essence of your business — whether you're an entrepreneur, small business owner, creative, or service provider. Each brand is unique, and your visuals should reflect that! With custom brand photography, we work closely with you to understand your brand's story, target audience, and goals. The result is a collection of bespoke images that authentically capture who you are, or what your product/service is and resonate with your audience.",
  },
  {
    question: "After My Brand Content Shoot, What Do I Get?",
    answer:
      "Professional headshots (that DON'T feel corporate-like or boring), authentic lifestyle images that show you, your product or service in action, high quality product photo and videos, and behind the scenes + user generated content. These carefully crafted assets can be used across your website, social media platforms, email marketing, print materials, and more — ensuring that your brand is consistently and powerfully represented at every customer touchpoint.",
  },
  {
    question: "How + Where Can I Use My Brand Photos?",
    answer:
      "These carefully crafted assets can be used across your website, social media platforms, email marketing, print materials, and more — ensuring that your brand is consistently and powerfully represented at every customer touchpoint.",
  },
  {
    question:
      "How Long Have You Been A Brand Photographer In The San Francisco Bay Area?",
    answer:
      "I've been a professional photographer for 9 years. I moved to the San Francisco Bay Area 7 years ago and it's been 2 years since I decided to fully niche down to Brand Content Creation.",
  },
  {
    question:
      "Can You Still Create Brand Content For Me If I Don't Live in The San Francisco Bay Area?",
    answer:
      "Yes! I am open to travel across the US and abroad, and I also shoot photo and video content for brands that ship their products directly to me. Whether you need product, lifestyle, or user generated content, think of me as your remote brand content creator.",
  },
];

export const aboutBio = {
  intro: "Hi there, I'm Keighla",
  tagline:
...
export const studioInfo = {
  name: "The Sausalito Studio",
  subtitle: "A Natural Light Studio in the Heart of Sausalito",
  description:
    "Just minutes from the Golden Gate Bridge, The Sausalito Studio is a bright, versatile space designed for photographers, creatives, and small business owners. Featuring abundant natural light, neutral tones, and a curated aesthetic, it's the perfect backdrop for photo shoots, portraits, product photography, and content creation.",
  secondaryText:
  ...
  membership: {
    ...
    description:
      "Join our community of photographers and creatives with a monthly studio membership. Enjoy discounted rental rates, priority booking, and flexible access starting at two days per month. Perfect for those who regularly shoot with clients, host workshops, or want to meet with their team in a professional, light-filled space.",
  },
  rental: {
    title: "One-Off Rentals",
    description:
      "Need the studio for a single project or event? The Sausalito Studio is available to book by the hour or day and is ideal for photo and video shoots, workshops, off-sites, co-working, or intimate gatherings.",
  },
};

export const brandSessionPackages = [
  {
    name: "The Brand Basic",
    description:
      'For business professionals on a tighter budget, this package captures your brand in a simple yet professional way. The "mini session" for brands who are just trying to get their foot in the door.',
    includes: [
      "Brand Questionnaire",
      "Posing Guidelines",
      "30 Minute Session",
    ...
    deliverables: [
      "15 Unique and Hand-Selected Fully Edited Images Delivered in an Online Gallery",
  ...
  {
    name: "The Brand Refresh",
    description:
      "Designed for business owners looking to update their brand's visual presence. With this personalized session, you'll receive refreshed, high-quality content that aligns with your evolving brand identity.",
    includes: [
      "Strategy Phone Call Before Our Session",
    ...
    deliverables: [
      ...
      "(3) :15 second video shorts (or gif/stop motion)",
      "+BTS Footage",
      "Commercial Use License",
    ],
  ...
  },
  {
    ...
    description:
      "Perfect for business owners who want to showcase their brand in its entirety. When we're done you will have everything you need to tell your brand story through high-quality, visually stunning content.",
    includes: [
      "Strategy Phone Call Before Our Session",
      "Location Scouting + Talent Casting (if needed)",
      "Brand Mood Board",
      "Posing Guidelines",
      "3-4 Hour Session",
      "Multiple Locations",
    ...
    deliverables: [
      "50-100 unique and hand-selected fully edited images delivered in an online gallery",
      "6 :15 second video shorts and/or gifs",
      "+BTS Footage",
      "Commercial Use License",
    ],
    price: "Inquire",
